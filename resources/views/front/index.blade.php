...
@section('content')
<div class="w-md-75">
    <h1 class="text-center mb-3 mb-md-5">システムへのご意見をお聞かせください。</h1>
    <form method="POST" action="{{ url('confirm')}}">
        @csrf
        <div class="form-group row">
            <label for="name" class="col-lg-3 col-form-label">氏名 <span class="text-danger">※</span></label>
            <div class="col-lg-9">
        ...
        <div class="form-group row">
            <label for="age_id" class="col-lg-3 col-form-label">年代 <span class="text-danger">※</span></label>
            <div class="col-lg-9">
        ...
        <div class="form-group row">
            <label for="email" class="col-lg-3 col-form-label">メールアドレス <span class="text-danger">※</span></label>
            <div class="col-lg-9">
        ...
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">メール送信可否</label>
            <div class="col-lg-9">
                <p>登録したメールアドレスにメールマガジンをお送りしてもよろしいですか？</p>
                <div class="form-check">
                    <input type="hidden" name="is_send_email" value="0">
                    @if( old("is_send_email")== '1')<input type="checkbox" name="is_send_email" value="1" id="sendEmail" class="form-check-input" checked>
                    @else<input type="checkbox" name="is_send_email" value="1" id="sendEmail" class="form-check-input">
                    @endif<label class="form-check-label" for="sendEmail">送信を許可します</label>
                </div>
            </div>
        </div>
        <div class="form-group row align-items-center mb-5">
            <label for="textarea" class="col-lg-3 col-form-label">ご意見</label>
            <div class="col-lg-9">
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-primary btn-lg btn-width">確認</button>
        </div>
    </form>
</div>
@endsection